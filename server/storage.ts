  ...
  private seedData() {
    ...
    const sampleJobs: Job[] = [
      ...
      },
      {
        ...
        description: "🚨 Now Hiring – Office Administrator 🚨\n\nWe are looking for a detail-oriented Office Administrator to join our team!\n\nKey Responsibilities:\n• Greeting and assisting visitors/clients\n• Scheduling meetings, appointments, and maintaining calendars\n• Preparing reports, memos, and other documents\n• Supporting day-to-day administrative operations\n\n📍 Location: Brampton\n💵 Pay Rate: $20/hr\n🕘 Shift: 9:00 AM – 5:00 PM",
        location: "Brampton",
        company: "Prime Trans Group",
        type: "Full-Time",
        category: "Administrative",
        requirements: "• Strong organizational and communication skills\n• Ability to manage multiple tasks effectively\n• Proficiency with MS Office (Word, Excel, Outlook) is an asset",
        salary: "$20/hr",
        featured: true,
        status: "approved",
        contactEmail: "hr@primetransgroup.com",
      ...
      },
      {
        ...
        description: "🚛 Now Hiring – Logistics Coordinator 🚛\n\nWe are seeking a motivated Logistics Coordinator to join our team and support day-to-day transportation and warehouse operations.\n\nMajor Duties:\n• Coordinate and schedule shipments, pickups, and deliveries\n• Communicate with drivers, carriers, and customers to ensure smooth operations\n• Track and monitor shipments to ensure timely delivery\n• Maintain accurate records of shipments, invoices, and documentation\n• Resolve delivery or scheduling issues quickly and effectively\n• Support compliance with company policies, safety, and industry regulations\n\n📍 Location: Mississauga\n💵 Pay Rate: $22/hr\n🕙 Shift: 10:00 AM – 6:00 PM",
        location: "Mississauga",
        company: "Prime Trans Group",
        type: "Full-Time",
        category: "Transportation",
        requirements: "• Previous experience in logistics/dispatching is an asset\n• Strong communication and problem-solving skills\n• Ability to multitask and work in a fast-paced environment\n• Computer proficiency (MS Office, dispatch/logistics software preferred)",
        salary: "$22/hr",
        featured: true,
        status: "approved",
        contactEmail: "hr@primetransgroup.com",
