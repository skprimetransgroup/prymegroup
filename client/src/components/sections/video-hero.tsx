    ...
    <section className="relative overflow-hidden">
      ...
      <div className="w-full bg-gray-200">
        <video 
          ...
          playsInline
          controls={false}
          className="w-full h-[50vh] sm:h-[60vh] lg:h-[70vh] object-cover block"
          data-testid="hero-video"
        >
          <source src={heroVideoPath} type="video/mp4" />
          <div className="w-full h-[50vh] sm:h-[60vh] lg:h-[70vh] bg-gray-300 flex items-center justify-center">
