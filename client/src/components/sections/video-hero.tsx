    ...
    <section className="relative overflow-hidden">
      ...
      <div className="relative bg-gradient-to-br from-black via-gray-900 to-black text-white py-16 overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
          {/* Left Side - Organized Professional Graphics */}
          <div className="flex items-center justify-center">
            <div className="relative">
              {/* Organized Background Elements - Grid Layout */}
              <div className="absolute -inset-24 grid grid-cols-3 grid-rows-3 gap-8 place-items-center">
                {/* Top Row */}
                <div className="bg-gradient-to-br from-primary/20 to-primary/10 backdrop-blur-sm rounded-full p-4 animate-float border border-white/10 shadow-xl">
                  <Truck className="w-6 h-6 text-primary" />
                </div>
                <div></div> {/* Empty space */}
                <div className="bg-gradient-to-br from-secondary/20 to-secondary/10 backdrop-blur-sm rounded-full p-4 animate-float-delayed border border-white/10 shadow-xl">
                ...
                {/* Bottom Row */}
                <div className="bg-gradient-to-br from-white/20 to-white/10 backdrop-blur-sm rounded-full p-4 animate-float border border-white/10 shadow-xl">
                  <Users className="w-6 h-6 text-white" />
                </div>
                <div></div> {/* Empty space */}
                <div className="bg-gradient-to-br from-primary/15 to-white/10 backdrop-blur-sm rounded-full p-3 animate-float-delayed border border-white/10 shadow-lg">
                  <Award className="w-5 h-5 text-primary" />
                </div>
              </div>
              
              {/* Central Professional Image - Simplified */}
              <div className="relative group">
                ...
                <div className="absolute -top-4 -right-4 bg-gradient-to-br from-primary to-secondary rounded-full p-4 shadow-xl border-2 border-white/20">
              ...
              <div className="relative">
                <h1 className="text-5xl lg:text-7xl font-bold text-white leading-tight">
                  ...
                  <span className="relative">
                    Workforce Solutions
                    {/* Clean Underline */}
                    <div className="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r from-primary to-secondary mt-2"></div>
                  </span>
                </h1>
                
                {/* Clean Badge */}
                <div className="absolute -top-6 right-0 bg-primary/20 backdrop-blur-sm text-primary text-sm font-bold px-3 py-1 rounded-full border border-primary/30">
                  #1 in Canada
                </div>
              </div>
