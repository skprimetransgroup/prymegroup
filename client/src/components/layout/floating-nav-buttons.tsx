...
export default function FloatingNavButtons() {
  ...
  return (
    <div className="absolute top-3/5 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10 hidden md:flex justify-center gap-4 max-w-[90vw] animate-fade-in-up">
