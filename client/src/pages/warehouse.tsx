    ...
    <>
      ...
      <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <section className="mb-20">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-foreground mb-4">See Our Operations in Action</h2>
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Experience the efficiency and precision of modern warehouse operations with our state-of-the-art equipment and processes
              </p>
            </div>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl bg-black">
                <video
                  ...
                  loop
                  playsInline
                  data-testid="video-forklift-operations"
                >
                  <source src="/api/public/forklift_warehouse.webm" type="video/webm" />
                  Your browser does not support the video tag.
                </video>
                
                {/* Video overlay for better visual presentation */}
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-6">
                  <div className="text-white">
                    <h3 className="text-xl font-bold mb-2">Professional Warehouse Operations</h3>
                    <p className="text-gray-200 text-sm">
                      Advanced forklift operations ensuring safe, efficient handling of your inventory
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-3 gap-6 mt-8">
                <div className="text-center p-4 bg-muted/30 rounded-lg">
                  ...
                  <p className="text-sm text-muted-foreground">OSHA-compliant operations with certified operators</p>
                </div>
                ...
                <div className="text-center p-4 bg-muted/30 rounded-lg">
                  ...
                  <h4 className="font-semibold text-foreground mb-2">Precision Handling</h4>
                  <p className="text-sm text-muted-foreground">Expert equipment operation for damage-free handling</p>
                </div>
                ...
                <div className="text-center p-4 bg-muted/30 rounded-lg">
                  ...
                  <h4 className="font-semibold text-foreground mb-2">24/7 Operations</h4>
                  <p className="text-sm text-muted-foreground">Round-the-clock warehouse operations when you need them</p>
                </div>
              </div>
            </div>
          </section>
