  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-background">
        ...
        {/* 3D Forklift Operations Section */}
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl lg:text-4xl font-bold text-white mb-4">
                Watch Our <span className="text-primary">Operations</span> in Action
              </h2>
              <p className="text-lg text-gray-300 max-w-2xl mx-auto">
                Experience our state-of-the-art warehouse operations with precision handling and efficient logistics
              </p>
            </div>
            
            <div className="relative">
              <Forklift3D className="mx-auto" />
              ...
              <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 bg-black/60 backdrop-blur-sm rounded-lg p-4 text-white">
                <div className="text-2xl font-bold text-green-400">500+</div>
                <div className="text-sm">Pallets/Hour</div>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6 mt-12">
              <div className="text-center p-6 bg-white/5 backdrop-blur-sm rounded-xl border border-white/10">
                ...
                <h3 className="text-lg font-semibold text-white mb-2">Automated Handling</h3>
                <p className="text-gray-300 text-sm">Advanced machinery for precise and efficient material handling</p>
              </div>
              ...
              <div className="text-center p-6 bg-white/5 backdrop-blur-sm rounded-xl border border-white/10">
                ...
                <p className="text-gray-300 text-sm">Live monitoring of all warehouse operations and inventory</p>
              </div>
              ...
              <div className="text-center p-6 bg-white/5 backdrop-blur-sm rounded-xl border border-white/10">
                ...
                <p className="text-gray-300 text-sm">Comprehensive safety protocols and equipment for all operations</p>
              </div>
            </div>
          </div>
