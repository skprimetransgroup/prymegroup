      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none space-y-8">
            ...
            <section>
              <h3 className="text-xl font-semibold text-foreground mb-3">What we track</h3>
              <p>
              ...
              <ul className="space-y-2 list-disc pl-6">
                <li>We track the number of visits to the Website, where each visitor came from (i.e. the website you visited prior to coming to the Website) and where each visitor goes to from the Website (i.e. the website you visit after leaving ours).</li>
                <li>A cookie is stored on your device for no longer than two (2) years which is linked to your IP address. Cookies are small text files that your web browser stores on your device. This allows us to track whether you return to the Website.</li>
              </ul>
            </section>

            <section>
              <h3 className="text-xl font-semibold text-foreground mb-3">How to manage cookies</h3>
              <p>
                If you do not wish us to track information through cookies you can configure your browser to reject cookies. If you wish to do so, please refer to your Internet browser's user instructions to find out how to delete and reject cookies. Note that the rejection of cookies may impact your user experience on the Website and restrict you from utilising certain site functionality and Services.
              </p>
            </section>
